      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur
           adipisicing elit. Nesciunt autem id exercitationem
            facilis quas aperiam impedit, obcaecati, eius harum
             minus quis? Repellat .
        </p>

        <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          <img src={apple} alt="apple_store" className='w-[128px] h-[128px] object-contain mr-5 cursor-pointer'/>
          <img src={google} alt="google_store" className='w-[128px] h-[128px] object-contain mr-5 cursor-pointer'/>
        </div>
      </div>
